...
ImGuiStyle::ImGuiStyle()
{
	...
	GrabRounding = 1.0f;             // Radius of grabs corners rounding. Set to 0.0f to have rectangular slider grabs.
...
#define GET_COLOR(r, g, b, a) ImVec4(r/255.0f, g/255.0f, b/255.0f, a);

	ImVec4 greenMain = GET_COLOR(135.0f, 207.0f, 95.0f, 0.83f);
	ImVec4 mainSolid = GET_COLOR(41, 126, 188, 1.0f);// GET_COLOR(117.0f, 176.0f, 83.0f, 1.0f);
	ImVec4 mainActive = GET_COLOR(61, 146, 208, 1.0f);
	ImVec4 mainCheckBox = GET_COLOR(101, 186, 248, 1.0f);
	ImVec4 buttonActive = GET_COLOR(115, 178, 198, 212.0f / 255.0f);
	ImVec4 darkGray1 = GET_COLOR(45.0f, 45.0f, 45.0f, 0.9f);
	ImVec4 darkGray2 = GET_COLOR(25.0f, 25.0f, 25.0f, 0.9f);
	ImVec4 lightGraySolid = GET_COLOR(80.0f, 80.0f, 80.0f, 0.9f);
	ImVec4 yellowActive = GET_COLOR(244.0f, 201.0f, 120.0f, 0.83f);
	ImVec4 titleCollapsed = GET_COLOR(40.0f, 40.0f, 40.0f, 170.0f / 255.0f);

	ImVec4 hoveredFrame = GET_COLOR(204, 220, 240, 102.0f / 255.0f);
	ImVec4 activeFrame = GET_COLOR(182, 228, 255, 150.0f / 255.0f);

#undef GET_COLOR

	Colors[ImGuiCol_Text] = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
	Colors[ImGuiCol_TextDisabled] = ImVec4(0.60f, 0.60f, 0.60f, 1.00f);
	Colors[ImGuiCol_WindowBg] = darkGray1;
	Colors[ImGuiCol_ChildWindowBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
	Colors[ImGuiCol_PopupBg] = ImVec4(0.05f, 0.05f, 0.10f, 0.90f);
	Colors[ImGuiCol_Border] = ImVec4(0.70f, 0.70f, 0.70f, 0.65f);
	Colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
	Colors[ImGuiCol_FrameBg] = ImVec4(0.80f, 0.80f, 0.80f, 0.40f);   // Background of checkbox, radio button, plot, slider, text input
	Colors[ImGuiCol_FrameBgHovered] = hoveredFrame;
	Colors[ImGuiCol_FrameBgActive] = activeFrame;
	Colors[ImGuiCol_TitleBg] = mainSolid;
	Colors[ImGuiCol_TitleBgCollapsed] = titleCollapsed;
	Colors[ImGuiCol_TitleBgActive] = mainActive;
	Colors[ImGuiCol_MenuBarBg] = ImVec4(0.40f, 0.40f, 0.55f, 0.80f);
	Colors[ImGuiCol_ScrollbarBg] = ImVec4(0.80f, 0.80f, 0.80f, 0.30f);
	Colors[ImGuiCol_ScrollbarGrab] = mainSolid;
	Colors[ImGuiCol_ScrollbarGrabHovered] = mainActive;
	Colors[ImGuiCol_ScrollbarGrabActive] = yellowActive;
	Colors[ImGuiCol_ComboBg] = darkGray2;
	Colors[ImGuiCol_CheckMark] = mainCheckBox;// ImVec4(0.90f, 0.90f, 0.90f, 0.50f);
	Colors[ImGuiCol_SliderGrab] = mainCheckBox;
	Colors[ImGuiCol_SliderGrabActive] = yellowActive;
	Colors[ImGuiCol_Button] = darkGray2;
	Colors[ImGuiCol_ButtonHovered] = mainSolid;
	Colors[ImGuiCol_ButtonActive] = buttonActive;
	Colors[ImGuiCol_Header] = darkGray2;
	Colors[ImGuiCol_HeaderHovered] = lightGraySolid;
	...
	Colors[ImGuiCol_ResizeGrip] = mainSolid;
	Colors[ImGuiCol_ResizeGripHovered] = mainActive;
...
bool ImGui::Begin(const char* name, bool* p_open, const ImVec2& size_on_first_use, float bg_alpha, ImGuiWindowFlags flags)
{
    ...
    if (first_begin_of_the_frame)
    {
        ...
        else
        {
            ...
            {
				if (flags & ImGuiWindowFlags_AutoResizeYOnly)
				{
            ...
            else if ((window->AutoFitFramesX > 0 || window->AutoFitFramesY > 0) && !window_size_set_by_api)
            {
				...
				if ((flags & ImGuiWindowFlags_AutoResizeYOnly) == 0)
				{
					if (window->AutoFitFramesX > 0)
						window->SizeFull.x = window->AutoFitOnlyGrows ? ImMax(window->SizeFull.x, size_auto_fit.x) : size_auto_fit.x;
				}
